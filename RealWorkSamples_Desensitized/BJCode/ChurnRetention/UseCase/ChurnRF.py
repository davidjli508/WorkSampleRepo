## Start-to-End Execution for BJ Client Churn Use Case with Random Forest Classifier
...
import Modeling.Classification.RandomForest as modeling
model_result = modeling.RunRandomForest(learning_df = model_df, preprocess_list = ["SMOTE", "NORMALIZE"], version_num = "v0", 
                               id_var = "CLIENT_ID_C", target_var = "CHURN", pred_df = model_df, use_case_desc = "Client Churn Use Case",
                               pred_table_name = mlc.CHURN_OUTPUT_TBL, details_table_name = mlc.RF_DETAIL_TBL, metrics_table_name = mlc.RF_METRICS_TBL, 
